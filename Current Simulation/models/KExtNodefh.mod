...
NEURON {
  SUFFIX KExtNodefh      :Suffix tells Neuron that this is a Density Mechanism, with Suffix KExtNode
...
PARAMETER {    :Parameters = constants
  ...
  : kbath   =  2.9 (mM)        : external bath concentration (set to 2.9 mM to match ko initial of fhspace)
}
...
DERIVATIVE state {
  ko' = (1e8)*ik/(fhspace*FARADAY):The DE for [K]ec -- term 1 = due to K+ currents
