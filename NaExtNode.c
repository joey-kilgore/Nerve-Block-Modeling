...
#define nrn_init _nrn_init__NaExtNode
#define _nrn_initial _nrn_initial__NaExtNode
#define nrn_cur _nrn_cur__NaExtNode
#define _nrn_current _nrn_current__NaExtNode
#define nrn_jacob _nrn_jacob__NaExtNode
#define nrn_state _nrn_state__NaExtNode
#define _net_receive _net_receive__NaExtNode 
#define state state__NaExtNode 
...
extern Memb_func* memb_func;
 ...
 "setdata_NaExtNode", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define nao0 nao0_NaExtNode
 double nao0 = 125;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaExtNode C:/Users/joeya/Desktop/NEURON_models/TestCNOW/NaExtNode.mod\n");
