...
#define nrn_init _nrn_init__SineRamp
#define _nrn_initial _nrn_initial__SineRamp
#define nrn_cur _nrn_cur__SineRamp
#define _nrn_current _nrn_current__SineRamp
#define nrn_jacob _nrn_jacob__SineRamp
#define nrn_state _nrn_state__SineRamp
#define _net_receive _net_receive__SineRamp 
...
#define HFAC_vec (_p + 24)
#define freq_vec (_p + 36)
#define Ramptime_vec (_p + 48)
#define segment _p[60]
#define num_of_pts _p[61]
#define TimeStop _p[62]
#define virtualfreq _p[63]
#define newendtime _p[64]
#define v _p[65]
#define _g _p[66]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 67, 2);
  hoc_register_dparam_semantics(_mechtype, 0, "area");
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 SineRamp C:/Users/joeya/Desktop/NEURON_models/TestCNOW/SineRamp.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ...
   if ( ( t < TimeStop ) ) {
     ...
     if ( freq  != 0.0 ) {
       ...
       virtualt = oldt + dt / 2.0 ;
       }
     }
   else if ( segment < num_of_pts ) {
     DCAmp = DCAmp_vec [ ((int) segment ) + 1 ] ;
     segment = segment + 1.0 ;
