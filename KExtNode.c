...
#define nrn_init _nrn_init__KExtNode
#define _nrn_initial _nrn_initial__KExtNode
#define nrn_cur _nrn_cur__KExtNode
#define _nrn_current _nrn_current__KExtNode
#define nrn_jacob _nrn_jacob__KExtNode
#define nrn_state _nrn_state__KExtNode
#define _net_receive _net_receive__KExtNode 
#define state state__KExtNode 
...
extern Memb_func* memb_func;
 ...
 "setdata_KExtNode", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define kbath kbath_KExtNode
 double kbath = 1.85;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 KExtNode C:/Users/joeya/Desktop/NEURON_models/TestCNOW/KExtNode.mod\n");
